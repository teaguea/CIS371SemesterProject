...
<html lang="en">
	...
	<?php
        ...
        $review = mysqli_real_escape_string($l, $_POST["vgrev"]);
        $reviewer = $_POST["reviewer"]; // required

	if($title  === "" || $company === "" || $writer === "" || $genre === "" || $review === "" || $reviewer === ""){
		...
		echo "<h3> Thank you $reviewer your review has been added!</h3>";
        	$query = "INSERT INTO Videogame(Title,Company,Genre,Review,Rname) VALUES ('$title', '$company', '$genre', '$review', '$reviewer');";
